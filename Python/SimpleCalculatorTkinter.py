...
class Calculator:
    ...
    for row in range(1,5) :
        for column in range(4) :
            ...
            count += 1 # Arranges buttons starting at 1 and going up
    # Arrange last button '=' at the bottom
    buttons[17].grid(row=5,column=0,columnspan=4)

    def createButton(self,val,write=True,width=7) :
        # This function creates a button, and takes one compulsory argument,
        # the value that should be on the button
    ...
    def click(self,text,write):
        ...
        # If None, nothing should not be written on screen.
        if write == None:
